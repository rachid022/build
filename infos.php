...
<head>
    ...
    <link rel="stylesheet" href="css/prvplcy.css">
        ...
        <div class="main-aside-div">
            ...
            ?>
                    ...
                    <div class="main-container">
                        <main>
                            <?php
                            $myarticle = $myarticlesdb->prepare("SELECT * FROM footer");
                            ...
                            ?>
                                ...
                                <?php foreach ($myarticle as $articles) { ?>
                                    ...
                                    <div style="text-align:center" class="articles-container" dir="ltr">
                                        <p class="title-post" dir="ltr"><?php echo $_GET['title']; ?></p>
                                        <div class="post-container">
                                            <div class="main-posts">
                                                <?php echo $articles[$_GET["swi"]] ?>
                                                <!-- <a href="#" class="read-more-link"> إقرأ المزيد </a> -->
                                            </div>
                                        </div>
                                        <p class="post-infos">
                                            Last Update<?php echo  " 2022" ?></p>
                                    </div>
